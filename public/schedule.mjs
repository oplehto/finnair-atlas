export function validateSchedule(data) {
  ...
  for(const f of data.flights){
    ...
    for(const key of ['airline','aircraft','number','status','days','frequency','operator','operatorFlight','via','connectingFrom','connectingTo','opens','wetlease','suspendedSince','source']) if(f[key]!==undefined&&typeof f[key]!=='string') throw Error(`${key} must be text.`);

...
function render(){
 ...
 // The strip's middle slot only reports progress now; what it used to say about box sizing and
 // crowded labels is explained in the sheet's own legend, where a reader is already looking.
